...
function saludo(idioma) {
  ...
  if(idiomas[idioma]==undefined) return "Hola!"
...
function colors(color) {
  ...
  if(colors[color]==undefined) return "Color not found"
  return colors[color]
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num1>num3 && num1>num2 && num1%2 ==0) return "Número 1 es mayor y positivo"
  if(num1<num3) return num3+1
  return false   
}
